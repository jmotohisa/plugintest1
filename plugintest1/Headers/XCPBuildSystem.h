...
// Generic command creation (return a XCDependencyCommand* ?)
...
#else
- (void)defineFileContents:(NSData*)content forAuxiliaryFileAtPath:(NSString*)path withPosixPermissions:(unsigned int)perms;
#endif
...
- (NSString*)symlinkContentsForAuxiliarySymlinkAtPath:(NSString*)path;
- (void)defineSymlinkContents:(NSString*)content forAuxiliarySymlinkAtPath:(NSString*)path;
