...
- (id)lineStartOffsets;
- (int)versionNumberComparison:(id)fp8;
#endif
@end
...
@interface NSCharacterSet (TSStringAdditions /*PBXTSStringAdditions in Xcode 3.0*/)
...
#if XCODE_VERSION >= 30
- (void)registerDefaultsOfContentsOfFile:(id)fp8;
- (id)objectForKey:(id)fp8 inVolatileDomainForName:(id)fp12;
- (id)objectForKey:(id)fp8 inPersistentDomainForName:(id)fp12;
- (BOOL)objectIsChangedForKey:(id)fp8;
#endif
@end
...
#if XCODE_VERSION >= 30
+ (id)invocationWithTarget:(id)fp8 selector:(SEL)fp12 object:(id)fp16 object:(id)fp20;
+ (id)invocationWithTarget:(id)fp8 selector:(SEL)fp12 argumentPointers:(void *)fp16;
#endif
@end
...
- (NSArray*)arrayByRecursivelyElidingEmptyStringValuesForDictionaryKeysInSet:(id)set;
	- (id)arrayByMakingObjectsPerformSelector:(SEL)fp8 withObject:(id)fp12 withObject:(id)fp16;
...
- (NSRange)characterRangeForLineRange:(NSRange)fp8;
- (NSRange)lineRangeForCharacterRange:(NSRange)fp8;
...
#else
- (void)appendUnsignedLEB128:(unsigned int)uleb128;
- (void)appendSignedLEB128:(int)leb128;
#endif
@end
